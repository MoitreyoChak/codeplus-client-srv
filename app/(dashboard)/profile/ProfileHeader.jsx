...
export default function ProfileHeader({ user }) {
  return (
    <div className="bg-[#1e1e1e] rounded-lg p-5">
      ...
      <button className="w-full mt-4 px-4 py-2 bg-transparent border border-green-600 text-green-400 rounded-md hover:bg-green-900/20 hover:text-green-300 transition-colors">
        Edit Profile
      </button>
    </div>
  );
