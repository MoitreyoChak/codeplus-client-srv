                    ...
                    <div className="rounded-lg bg-black/30 px-6 pt-4 pb-2.25 mb-4">
                        <div className="flex justify-between">
                            ...
                            <div className="flex items-center space-x-2 mb-4">
                                <span
                                    className={`text-sm py-0.5 px-2 rounded-md ${question.status === "Solved"
            ...
            >
                ...
                >
                    <div className="flex ml-2 mt-2 gap-2 text-xs">
                        <div className={`border py-0.5 px-3 cursor-pointer rounded ${testCaseModal ? 'bg-gray-400 border-transparent' : ''} transition-all duration-500`} onClick={() => setTestCaseModal(true)}>TestCases</div>
